            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent transition-colors"
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              <input
                ...
                className="flex-1 md:w-64 px-4 py-2 rounded-md bg-white/10 border border-white/20 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-accent"
              />
          ...
          <div className="flex flex-col md:flex-row items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="https://www.facebook.com/fady.gerges.kodsy/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <Facebook className="h-4 w-4 hover:text-white transition-colors" />
              </a>
              <a href="https://www.linkedin.com/in/fady-gerges-kodsy/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <Linkedin className="h-4 w-4 hover:text-white transition-colors" />
              </a>
            </div>
          </div>
